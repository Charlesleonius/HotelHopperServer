...
const ReservedRoom = sequelize.import('reservations/reserved-room.js');
...
//ReservedRoom -> Reservation
ReservedRoom.belongsTo(Reservation, { foreignKey: 'reservation_id', sourceKey: 'reservation_id' });
